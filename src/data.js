const services = [
  {
    id: 1,
    service: 'Orthopedic',
    image: 'https://i.ibb.co/Kq5SbqX/broken-leg.png',
    img: 'https://i.ibb.co/yY3NkWY/orthopedic.jpg',
    description:
    ...
    expert: 'Will Smith',
    job: 'Senior Orthpedics',
  },
  {
    id: 2,
    service: 'Dermatology',
    image: 'https://i.ibb.co/PhfWwwS/allergy.png',
    img: 'https://i.ibb.co/tmVM5yj/dermatology.jpg',
    description:
  ...
  },
  {
    id: 3,
    service: 'Surgery',
    image: 'https://i.ibb.co/g45GYXz/surgery-tools.png',
    img: 'https://i.ibb.co/kSrjGGm/surgery.jpg',
    description:
    ...
    tests: {
      num1: 'General surgery',
      num2: 'Cardiothoracic',
      num3: 'Dental surgery',
      num4: 'Neurosurgery',
    },
    expert: 'Mathew dayane',
    job: 'Senior Surgeon',
  },
  {
    id: 4,
    service: 'Neurology',
    image: 'https://i.ibb.co/kgtsyvr/idea.png',
    img: 'https://i.ibb.co/KDwzkpH/Surgeons-Perform-Brain-Surgery-Using-Augmented-Reality-Animated-3-D-Brain-High-Tech-Technologically.jpg',
    description:
    ...
    tests: {
      num1: 'Genetic testing',
      num2: 'Brain scans',
      num3: 'CT scan',
      num4: 'MRI scan',
    },
    expert: 'Smith hope',
    job: 'Senior Neurologist',
  },
];
